...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService("AuthService",
                ...
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "SPRING_JWT_SECRET=dGhpc2lzYXZlcnlsb25nc2VjcmV0a2V5Zm9yand0dG9rZW5nZW5lcmF0aW9uYW5kdmFsaWRhdGlvbjEyMzQ1Ng=="));
        ...
        FargateService patientService =
                createFargateService("PatientsService",
                        "patients-service",
                        List.of(4000),
                        patientServiceDb,
                        Map.of(
    ...
    private CfnCluster createMskCluster(){
        return CfnCluster.Builder
                ...
                .kafkaVersion("2.8.0")
                .numberOfBrokerNodes(1) //LOCALSTACK has only support for 1
    ...
    private FargateService createFargateService(String id ,
        ...
        if(db != null){
            ...
            envVars.put("SPRING_DATASOURCE_PASSWORD", Objects.requireNonNull(db.getSecret())
